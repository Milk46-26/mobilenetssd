...
lineaccesstoken = 'VvIMR+yxvo+8s0FSpYooGgeNwOVrJPg+iET3qZGFyM02ky9RtxgzEsjqdzP39OIQdNC2Qt7tZHFPTiwaC+18Oq4/msEw/R27XNTzxuJV1hNibdL6BjCXOwRGvgQQR61QBZFK3fOnw9dKo5mBmyxF1QdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == ("สวัสดี") :
            ...
            replyObj = TextSendMessage(text="ไม่อ่ะ ขอเป็นสเต็ก") 
            line_bot_api.reply_message(rtoken, replyObj)   
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/5049b167-a3dc-4f0c-8f8e-c2eebbcab567"
